...
- **EMA フィルタ** — ラウンド間ノイズを平滑化（α=0.35 デフォルト）
...
2. VS Code を開き、Extensions 右側のツールバーにあるアイコンをクリックします（**拡張機能の管理**を参照）。
...
4. [**Git**](https://github.com/git-guides/install-git) をインストールしてください。
...
- **EMA フィルタ** — α=0.35 で TDM 周期間のノイズを平滑化
...
| `EMA_ALPHA` | `lib/LAPTIMER/laptimer.cpp` | 7 | EMA ゲイン (0〜20、α=EMA_ALPHA/20) |
