...
class RX5808 {
   public:
    ...
    // For 4ch scanner: get current frequency without triggering change
    uint16_t getCurrentFrequency() { return currentFrequency; }

   private:
    uint8_t rx5808DataPin = 0;
    uint8_t rx5808ClkPin = 0;
    uint8_t rx5808SelPin = 0;
